      ...
      <div className='navbar-container row' onMouseLeave={this.handleOnMouseLeave}>
        ...
        <div className='login-icon' onMouseEnter={this.handleOnMouseEnter}>
        {
          ...
          <div className={this.context.logoutInfo}>
            ...
            <button onClick={this.context.handleConfirmLogout} className='confirm-edit-button'>Confirm</button>
            <button onClick={this.context.handleCancelLogout} className='cancel-button'>Cancel</button>
          </div>
      </div>
    );
  }
